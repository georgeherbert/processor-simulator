...
struct com_data_bus
{
    struct com_data_bus_inst current;
    struct com_data_bus_inst next;
...
void com_data_bus_add_entry(struct com_data_bus *cbd, uint32_t qi, uint32_t val); // Put val from qi on common data bus
bool com_data_bus_is_val_ready(struct com_data_bus *cbd, uint32_t qi);            // Check if val from qi is on common data bus
uint32_t com_data_bus_get_val(struct com_data_bus *cbd, uint32_t qi);             // Get val from qi from common data bus
void com_data_bus_step(struct com_data_bus *cbd);                                 // Step common data bus
void com_data_bus_update_current(struct com_data_bus *cbd);                       // Update current common data bus
